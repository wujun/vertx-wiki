...
package io.vertx.starter.database.rxjava;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.starter.database.WikiDatabaseService original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(io.vertx.starter.database.WikiDatabaseService.class)
public class WikiDatabaseService {
  ...
  public static final io.vertx.lang.rxjava.TypeArg<WikiDatabaseService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new WikiDatabaseService((io.vertx.starter.database.WikiDatabaseService) obj),
    WikiDatabaseService::getDelegate
  );

  private final io.vertx.starter.database.WikiDatabaseService delegate;
  
  public WikiDatabaseService(io.vertx.starter.database.WikiDatabaseService delegate) {
    this.delegate = delegate;
  }

  public io.vertx.starter.database.WikiDatabaseService getDelegate() {
    return delegate;
  }
  ...
  public static  WikiDatabaseService newInstance(io.vertx.starter.database.WikiDatabaseService arg) {
